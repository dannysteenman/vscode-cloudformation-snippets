...
- Parsed body in a seperate function, simplified tabbing of properties
  ...
  Steenman]
- Changelog version: 3.1.0. [Github Actions]
...
- Changelog version: 2.26.0. [Azure Pipeline]
...
- Changelog version: 2.25.0. [Azure Pipeline]
...
- Changelog version: 2.24.0. [Azure Pipeline]
...
- Changelog version: 2.23.0. [Azure Pipeline]
...
- The following resource was updated: AWS::AmazonMQ::Broker. [Azure
  Pipeline]
- Changelog version: 2.22.0. [Azure Pipeline]
...
- Changelog version: 2.21.0. [Azure Pipeline]
...
- Changelog version: 2.20.0. [Azure Pipeline]
...
- The following resource was updated: AWS::CodeCommit::Repository Code.
  [Azure Pipeline]
- Changelog version: 2.19.0. [Azure Pipeline]


2.19.0 (2020-08-28)
-------------------
- The following resource was updated: AWS::KMS::Key. [Azure Pipeline]
- Changelog version: 2.18.0. [Azure Pipeline]
...
- The following resources were updated: AWS::ECS::TaskDefinition. [Azure
  Pipeline]
- Changelog version: 2.17.0. [Azure Pipeline]
...
- The following resources were updated: AWS::ECS::TaskDefinition. [Azure
  Pipeline]
- Changelog version: 2.16.0. [Azure Pipeline]
...
- Changelog version: 2.15.0. [Azure Pipeline]
...
- The following resource was updated: AWS::Amplify::Domain. [Azure
  Pipeline]
- Changelog version: 2.14.0. [Azure Pipeline]
...
- Changelog version: 2.13.0. [Azure Pipeline]
...
- The following resource was updated: AWS::EFS::FileSystem. [Azure
  Pipeline]
- Changelog version: 2.12.0. [Azure Pipeline]
...
- The following resource was added: AWS::IoT::ProvisioningTemplate.
  [Azure Pipeline]
- Changelog version: 2.11.0. [Azure Pipeline]
...
- The following resources was updated: AWS::CodeBuild::ReportGroup.
  [Azure Pipeline]
- Changelog version: 2.10.0. [Azure Pipeline]
...
- The following resource was updated: AWS::IoTEvents::DetectorModel.
  [Azure Pipeline]
- Changelog version: 2.9.0. [Azure Pipeline]
...
- The following resource was updated: AWS::Synthetics::Canary. [Azure
  Pipeline]
- Changelog version: 2.8.0. [Azure Pipeline]
...
- Changelog version: 2.7.0. [Azure Pipeline]
...
- The following resource was updated: AWS::Glue::DevEndpoint. [Azure
  Pipeline]
- Changelog version: 2.6.0. [Azure Pipeline]
...
- The following resource was updated: AWS::CloudWatch::InsightRule.
  [Azure Pipeline]
- Changelog version: 2.5.0. [Azure Pipeline]
...
- The following resource was updated: AWS::CloudWatch::InsightRule.
  [Azure Pipeline]
- Changelog version: 2.4.0. [Azure Pipeline]
...
- The following resource was updated: AWS::DMS::Endpoint. [Azure
  Pipeline]
- Changelog version: 2.3.0. [Azure Pipeline]
...
- Changelog version: 2.2.0. [Azure Pipeline]
...
- Changelog version: 2.1.0. [Azure Pipeline]
...
- Changelog version: 2.0.0. [Danny Steenman]
...
- The following was added: You can now use intrinsic function snippets!
  [Danny Steenman]
- Changelog version: 1.30.0. [Azure Pipeline]
...
- The following resources were updated: AWS::Pinpoint::EmailTemplate,
  ...
  Pipeline]
- Changelog version: 1.29.0. [Azure Pipeline]
...
- The following resource was updated: AWS::Lambda::Function. [Azure
  Pipeline]
- Changelog version: 1.28.0. [Azure Pipeline]
...
- Changelog version: 1.27.0. [Azure Pipeline]
...
- Changelog version: 1.26.0. [Azure Pipeline]
...
- The following resources were updated: <code
  ...
  class="code">AWS::ApiGatewayV2::Integration</code>,  <code
  class="code">AWS::ApiGatewayV2::Stage</code>. [Azure Pipeline]
- Changelog version: 1.25.0. [Azure Pipeline]
...
- The following resource was added: AWS::Lambda::EventInvokeConfig.
  [Azure Pipeline]
- Changelog version: 1.24.0. [Azure Pipeline]
...
- Changelog version: 1.21.0. [Azure Pipeline]
...
- The following resource was updated: AWS::AppMesh::Route. [Azure
  Pipeline]
- Changelog version: 1.20.0. [Azure Pipeline]
...
- The following resource was updated: AWS::MSK::Cluster. [Azure
  Pipeline]
- Changelog version: 1.19.0. [Azure Pipeline]
...
- Changelog version: 1.18.0. [Azure Pipeline]
...
- The following resource was updated: AWS::Glue::DevEndpoint. [Azure
  Pipeline]
- Changelog version: 1.17.0. [Azure Pipeline]
...
- Changelog version: 1.16.0. [Azure Pipeline]
...
- Changelog version: 1.15.0. [Azure Pipeline]


1.15.0 (2019-08-29)
-------------------
- The following resource was updated: Route. [Azure Pipeline]
- Changelog version: 1.14.0. [Azure Pipeline]
...
- The following resource was updated: AWS::DMS::ReplicationTask. [Azure
  Pipeline]
- Changelog version: 1.13.0. [Azure Pipeline]
...
- Changelog version: 1.12.0. [Azure Pipeline]
...
- Changelog version: 1.11.0. [Azure Pipeline]
...
- The following resource was updated: AWS::AmazonMQ::Broker. [Azure
  Pipeline]
- Changelog version: 1.10.0. [Azure Pipeline]
...
- The following resource was added: AWS::CloudWatch::AnomalyDetector.
  [Azure Pipeline]
- Changelog version: 1.9.0. [Azure Pipeline]
...
- Changelog version: 1.8.0. [Azure Pipeline]
...
- The following resource was updated: AWS::EC2::LaunchTemplate. [Azure
  Pipeline]
- Changelog version: 1.7.0. [Azure Pipeline]
...
- The following resources were updated: AWS::AppMesh::VirtualNode,
  ...
  Pipeline]
- Changelog version: 1.6.0. [Azure Pipeline]
...
- Changelog version: 1.5.0. [Azure Pipeline]
...
- The following resources were updated: AWS::AppSync::GraphQLApi,
  ...
  Pipeline]
- Changelog version: 1.4.0. [Azure Pipeline]
...
- Changelog version: 1.3.0. [Azure Pipeline]
...
- Changelog version: 1.2.0. [Azure Pipeline]
